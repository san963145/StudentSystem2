...
/**
 * Servlet implementation class CardGroupByMajor
 */
@WebServlet("/CardGroupByMajor")
public class CardGroupByMajor extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CardGroupByMajor() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List cardList=CardDao.get(department, null, grade, sexNum, "major");
		...
		request.getRequestDispatcher("pages/index/cardGroupByMajor.jsp").forward(request, response);
	}
