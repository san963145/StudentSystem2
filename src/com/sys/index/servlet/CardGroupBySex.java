...
/**
 * Servlet implementation class CardGroupBySex
 */
@WebServlet("/CardGroupBySex")
public class CardGroupBySex extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CardGroupBySex() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List cardList=CardDao.get(department, majorNum, grade, null, "sex");
		...
		request.getRequestDispatcher("pages/index/cardGroupBySex.jsp").forward(request, response);
	}
