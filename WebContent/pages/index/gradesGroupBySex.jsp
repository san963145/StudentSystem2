      ...
      <div class="content-wrapper">
		...
		<script>
         ...
         {        	 
        	 ...
        	 location="GradesGroupByCollege?sex="+sex;
         }
         function getByMajor(sex)
         {
        	 ...
        	 document.cookie='grade='+encodeURI(grade); 
        	 document.cookie='str='+encodeURI(str); 
        	 location="GradesGroupByMajor?sex="+sex;
         }
         function getByGrade(sex)
         {
        	 ...
        	 document.cookie='str='+encodeURI(str); 
        	 location="GradesGroupByGrade?sex="+sex;
         }
        </script>
					...
					<div class="col-md-6 col-md-offset-3">	
						<div class="box box-warning">
				            ...
				            <div class="box-footer">
				                ...
				                <%if(department==null){ %>
				            	<a class="btn btn-warning btn-sm" onclick="getByDepartment('<%=key%>')"><small>按学院细分</small></a>
				            	<%} %>
