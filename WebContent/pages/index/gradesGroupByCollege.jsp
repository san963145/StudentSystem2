      ...
      <div class="content-wrapper">
		...
		<script>
         ...
         {        	 
        	 ...
        	 location="GradesGroupByMajor?department="+encodeURI(encodeURI(department));
         }
         function getByGrade(department)
         {
        	 ...
        	 document.cookie='sex='+encodeURI(sex); 
        	 document.cookie='str='+encodeURI(str);  
        	 location="GradesGroupByGrade?department="+encodeURI(encodeURI(department));
         }
         function getBySex(department)
         {
        	 ...
        	 document.cookie='grade='+encodeURI(grade); 
        	 document.cookie='str='+encodeURI(str);  
        	 location="GradesGroupBySex?department="+encodeURI(encodeURI(department));
         }
        </script>
					...
					<div class="col-md-6 col-md-offset-3">	
						<div class="box box-warning">
				            ...
				            <div class="box-footer">
				                ...
				                <a class="btn btn-warning btn-sm" onclick="getByMajor('<%=key%>')"><small>按专业细分</small></a>
				                <%if(grade==null){ %>
