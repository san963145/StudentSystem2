      ...
      <div class="content-wrapper">
		...
		<script>
         ...
         {        	 
        	 ...
        	 location="CardGroupByMajor?department="+encodeURI(encodeURI(department));
         }
         function getByGrade(department)
         {
        	 ...
        	 document.cookie='sex='+encodeURI(sex); 
        	 document.cookie='str='+encodeURI(str);  
        	 location="CardGroupByGrade?department="+encodeURI(encodeURI(department));
         }
         function getBySex(department)
         {
        	 ...
        	 document.cookie='grade='+encodeURI(grade); 
        	 document.cookie='str='+encodeURI(str);  
        	 location="CardGroupBySex?department="+encodeURI(encodeURI(department));
         }
        </script>
        <div class="row">
					...
					<div class="col-md-6 col-md-offset-3">	
						<div class="box box-info">
				            ...
				            <div class="box-footer">
				                ...
				                <%} %>
				                <%if(sex==null){ %>
				                <a class="btn btn-info btn-sm" onclick="getBySex('<%=obj[0].toString()%>')"><small>按性别细分</small></a>
				                <%} %>
				            	</div>
				             </div>
			            </div>
