      ...
      <div class="content-wrapper">
        ...
        <script>
         ...
         function getByGrade(major)
         {
        	 ...
        	 location="CardGroupByGrade?major="+major;
         }
         function getBySex(major)
         {
        	 ...
        	 document.cookie='str='+encodeURI(str); 
        	 location="CardGroupBySex?major="+major;
         }
        </script>
        <div class="row">
           ...
           <%
              ...
              String majorNum=MajorNameDao.getNumByName(department,obj[0].toString());
           %>
        	<div class="col-md-12">	
        		<section class="content-header">
		          <h4><%=obj[0].toString() %></h4>
		        </section>
					...
					<div class="col-md-6 col-md-offset-3">	
						<div class="box box-info">
				            <div class="box-header">
				              <h3 class="box-title"><small>该专业学生消费均值（单位：元）</small></h3>
				            </div>
				            <!-- /.box-header -->
				            <div class="box-body">
				            ...
				            <div class="box-footer">
				            	...
				            	<%if(grade==null){ %>
				                <a class="btn btn-info btn-sm" onclick="getByGrade('<%=majorNum%>')"><small>按年级细分</small></a>
				                <%} %>
				                <%if(sex==null){ %>
				                <a class="btn btn-info btn-sm" onclick="getBySex('<%=majorNum%>')"><small>按性别细分</small></a>
				                <%} %>
				            	</div>
				             </div>
			            </div>
