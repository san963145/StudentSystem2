      ...
      <div class="content-wrapper">
		...
		<script>
         ...
         {        	 
        	 ...
        	 location="NetworkGroupByCollege?sex="+sex;
         }
         function getByMajor(sex)
         {
        	 ...
        	 document.cookie='grade='+encodeURI(grade); 
        	 document.cookie='str='+encodeURI(str); 
        	 location="NetworkGroupByMajor?sex="+sex;
         }
         function getByGrade(sex)
         {
        	 ...
        	 document.cookie='str='+encodeURI(str); 
        	 location="NetworkGroupByGrade?sex="+sex;
         }
        </script>
        <div class="row">
        <%
					...
					<div class="col-md-6 col-md-offset-3">	
						<div class="box box-success">
				            ...
				            <div class="box-footer">
				                ...
				                <%if(department==null){ %>
				            	<a class="btn btn-info btn-sm" onclick="getByDepartment('<%=key%>')"><small>按学院细分</small></a>
				            	<%} %>
