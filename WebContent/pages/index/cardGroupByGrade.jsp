      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         { 
        	 ...
        	 location="CardGroupByCollege?grade="+grade;
         }
         function getByMajor(grade)
         {
        	 ...
        	 document.cookie='sex='+encodeURI(sex); 
        	 document.cookie='str='+encodeURI(str); 
        	 location="CardGroupByMajor?grade="+grade;
         }
         function getBySex(grade)
         {
        	 ...
        	 document.cookie='str='+encodeURI(str);  
        	 location="CardGroupBySex?grade="+grade;
         }
        </script>
        <div class="row">
           ...
           <%
              ...
              String gradeName="20"+obj[0].toString();
					...
					<div class="col-md-6 col-md-offset-3">	
						<div class="box box-info">
				            ...
				            <div class="box-footer">
				            	...
				            	<%if(department==null){ %>
				            	<a class="btn btn-info btn-sm" onclick="getByDepartment('<%=gradeName%>')"><small>按学院细分</small></a>
				            	<%} %>
				            	<%if(department!=null&&major==null){ %>
				                <a class="btn btn-info btn-sm" onclick="getByMajor('<%=gradeName%>')"><small>按专业细分</small></a>
				                <%} %>
				                <%if(sex==null){ %>
				                <a class="btn btn-info btn-sm" onclick="getBySex('<%=gradeName%>')"><small>按性别细分</small></a>
				                <%} %>
				            	</div>
				             </div>
			            </div>
