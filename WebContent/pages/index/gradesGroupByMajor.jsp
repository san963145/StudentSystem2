<%@page import="com.sys.manager.bean.*" import="com.sys.manager.dao.*" import="com.sys.card.dao.*" import="com.sys.network.bean.*" import="com.wiscom.is.*, java.net.*"%>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<%} %>
			    <li class="active">按专业划分</li>
			</ol>
		</section>
		<script>

         function getByGrade(major)
         {
        	 var sex="";
        	 ...
        	 location="GradesGroupByGrade?major="+major;
         }
         function getBySex(major)
         {
        	 var department="";
        	 if(document.getElementById("department"))
        		 department=document.getElementById("department").innerHTML;
        	 ...
        	 document.cookie='str='+encodeURI(str); 
        	 location="GradesGroupBySex?major="+major;
         }
        </script>
            ...
            <%
               if(gradesMap!=null){
                ...
                while(it.hasNext()){
        	      ...
        	      String majorName=MajorNameDao.getNameByNum(key);
        	      i++;
            %>
        	<div class="col-md-12">	
        		<section class="content-header">
					...
					<div class="col-md-6 col-md-offset-3">	
						<div class="box box-warning">
				            ...
				            <div class="box-footer">
				                ...
				                <%if(grade==null){ %>
				                <a class="btn btn-warning btn-sm" onclick="getByGrade('<%=key%>')"><small>按年级细分</small></a>
				                <%} %>
				                <%if(sex==null){ %>
				                <a class="btn btn-warning btn-sm" onclick="getBySex('<%=key%>')"><small>按性别细分</small></a>
				                <%} %>
				            	</div>
				             </div>
			            </div>
