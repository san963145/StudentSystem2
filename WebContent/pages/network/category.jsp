			...
			<!-- SELECT2 EXAMPLE -->
			  <div class="box box-success">
				<div class="box-header with-border">
				  <h3 class="box-title">分层浏览</h3>
				</div><!-- /.box-header -->
				<div class="box-body">
					<div class="col-md-8 col-md-offset-2">
					    <!--li 属性里的 
						    data-target="#listGroupXXXXXX" 是点击后要下拉的ul的id 记得复制的时候更改  对应的ul的id也记得改
						    data-parent 属性是为了同父结点的 结点同时只打开一个，也就是打开一个列表的时候 同级的其他列表收回。 不过好像失效了可以无视。
						-->
						<%=s %>
