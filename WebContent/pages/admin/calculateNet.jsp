     ...
     <script>
					...
					function send()
					{
                        if(flag)
                        {
						  ...
						  x.open("GET","Calculate?step=0",true);
					...
					function update()
					{
						...
						if(x.readyState==4 && x.status==200)
						{
							...
							if(x.responseText=="0")      
							{
								...
								sleep(1000);
								x.open("GET","Calculate?step="+step,true);
								x.onreadystatechange=update;
								x.send();
								return ;
							}
							...
							if(step==1)
						    {
							 x.open("GET","Calculate?step=1",true);
							 x.onreadystatechange=update;
							 x.send();
						    }
							else if(step==2)
						    {
								x.open("GET","Calculate?step=2",true);
								x.onreadystatechange=update;
								x.send();
						    }
...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="main.jsp" ><i class="fa fa-dashboard"></i> 主页</a></li>
